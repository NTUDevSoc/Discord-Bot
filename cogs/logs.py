...
class Logs(commands.Cog):
    ...
    def message_logs(self, message, before = None):
        ...
        #Title and Footer depending on Delete or Edit
        if before != None:
            embed=discord.Embed(title="__**Message Edited**__", description="Message Author: "+message.author.mention, url=message.jump_url, color=0xe7ec11)
        ...
        if message.attachments:
            ...
            #If first attachment is an image, will post it
